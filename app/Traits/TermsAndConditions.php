    ...
    public function termsAndConditions(){
        ...
        <div class='col-12'>
            <div className='container terms-and-conditions-div'>
                <h4>Dyna Pro & Super Pro with 10 & 20 Years Warranty</h4>
                <p>
                ...
                <h4 style='color:red'>Other excluded situations</h4>
                <p>
                ...
                <h4 style='color:red'>Do’s and Don’ts:</h4>
                ...
                <h4 style='color:red'>Disclaimer of other warranties</h4>
                <p>
                ...
                <h4 style='color:red'>Limitation of remedies and liability:</h4>
                <p>
                ...
                <h4 style='color:red'>Entire understanding:</h4>
                <p>
                ...
                <h4 style='color:red'>Warranty not transferable:</h4>
                <p>
                ...
                <h4 style='color:red'>Non waiver:</h4>
                <p>
                ...
                <h4 style='color:red'>Governing law and jurisdiction:</h4>
                <p>
